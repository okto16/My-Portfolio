...
const Footer = () => {
  const socialLinks = [
    ...
    {
      href: "https://www.instagram.com/oktorino_bagas/",
      icon: Instagram,
      size: "w-5 h-5 sm:w-7 sm:h-7 lg:w-8 lg:h-8",
      name: "Instagram",
    },
    {
      href: "https://www.linkedin.com/in/oktorino-bagas-aji-sudarno",
      icon: Linkedin,
      size: "w-4 h-4 sm:w-6 sm:h-6 lg:w-8 lg:h-8",
      name: "Linkedin",
    },
  ...
  return (
    <footer className="py-8 sm:py-12 lg:py-16">
      <div className="text-center">
        <h2 className="text-lg sm:text-2xl lg:text-3xl mb-4 sm:mb-6" style="">
          Connect with me
        </h2>
